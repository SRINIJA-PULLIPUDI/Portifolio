document.addEventListener('DOMContentLoaded', () => {
    ...
    // Header active state and menu bar
    ...
    document.addEventListener('click', (e) => {
        if (!navMenu.contains(e.target) && !menuBar.contains(e.target) && navMenu.classList.contains('active')) {
            navMenu.classList.remove('active');
        }
    });
    ...
    document.querySelectorAll('.cardleetcode').forEach(ele => {
        observer4.observe(ele);
    });
    ...
    document.querySelectorAll('.cardcodechef').forEach(ele => {
        observer5.observe(ele);
    });
    ...
    document.querySelectorAll('.cardhackerrank').forEach(ele => {
        observer6.observe(ele);
    });
    ...
    document.querySelectorAll('.cardgfg').forEach(ele => {
        observer7.observe(ele);
    });
    ...
    document.querySelectorAll('.cardgit').forEach(ele => {
    ...
    window.copyPhoneNumber = function() {
        const phoneNumber = 'YOUR_PHONE_NUMBER_HERE'; // Replace with your actual phone number
